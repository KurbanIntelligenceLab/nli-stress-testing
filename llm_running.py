...
for m in models:
    ...
    # Directory setup
    DATA_DIR = "/content/drive/MyDrive/THESIS/Multilingual Stress Testing LLMs - Entailment/multilingual_nli"
    OUTPUT_DIR = "/content/drive/MyDrive/THESIS/Multilingual Stress Testing LLMs - Entailment/nli_llm_outputs"
    ...
    for file in os.listdir(DATA_DIR):
        ...
        output_path = os.path.join(OUTPUT_DIR, f"{model_n}_classified_{lang}.jsonl")
